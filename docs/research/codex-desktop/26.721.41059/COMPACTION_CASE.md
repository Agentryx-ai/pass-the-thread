...
This was a long Claude source with a recorded compact boundary. It demonstrates why a successful import write is not enough to establish that the resulting Codex thread can continue safely.
